     ...
     <>
       <div className="container mt-5">
         <div className="row justify-content-center">
           ...
           <p className="text-center">Veuillez entrer votre adresse e-mail pour réinitialiser votre mot de passe.</p>
               ...
               <div className="row">
                ...
                {inputerror.email &&  <small className="error">{inputerror.email}</small>}  
                 </div>
                 {!forgotpass && (
                   <div className="col-sm-12" >
                     ...
                     {inputerror.password &&  <small className="error">{inputerror.password}</small>}
